    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                newOrder = new order_model_1.OrderModel(__assign({}, requestOrder));
...
function getNewOrderForCurrentUser(req) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, order_model_1.OrderModel.findOne({ status: order_status_1.OrderStatus.NEW }).sort({ createdAt: -1 })];
                case 1: 
