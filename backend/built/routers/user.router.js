    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, user_model_1.UserModel.findOne({ email: email.toLowerCase() })];
            case 1:
                user = _c.sent();
                _b = user;
...
router.post('/register', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, address, user, encryptedPassword, newUser, createdUser;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                user = _b.sent();
                if (user) {
                    res.status(http_status_1.HTTP_BAD_REQUEST).send({ message: 'User already exists' });
                    return [2 /*return*/];
                }
